...
## СОДЕРЖАНИЕ
[Общие моменты](общиемоменты)
[Навигация](навигация)
[Чтение файлов](чтениефайлов)
[Манипулирование файловой структурой](манипулированиефайловойструктурой)
[Потоки](потоки)
[Пайплайн](пайплайн)
[Переменные окружения](переменныеокружения)
[История](история)
[sudo](sudo)
[Пакетный менеджер](пакетныйменеджер)
